...
class Window:
    ...
    def capture(self):
        ...
        cDC.BitBlt((0, 0), (self.width - 300, self.height - 300), dcObj, (self.cropped_x + 50, self.cropped_y + 50),
                   win32con.SRCCOPY)
...
class OskWindow(Window):
    ...
    def test_keys(self):
        ...
        sleep(0.2)
        self.press_key(button='3', mode='click')
        sleep(0.2)
        self.press_key(button='4', mode='click')
        sleep(0.2)
        self.press_key(button='space', mode='click')
        sleep(0.2)
        self.press_key(button='Fn', mode='click')
        sleep(0.2)
        self.press_key(button='Alt', mode='click')
        sleep(0.2)
        self.press_key(button='Ctrl', mode='click')
        sleep(0.2)
        self.press_key(button='z', mode='click')
        sleep(0.2)
        self.press_key(button='y', mode='click')
        sleep(0.2)
        self.press_key(button='e', mode='click')
        sleep(0.2)
        self.press_key(button='q', mode='click')
        sleep(0.2)
        self.press_key(button='g', mode='click')
        sleep(0.2)
        self.press_key(button='t', mode='click')
        sleep(0.2)
        self.press_key(button='h', mode='click')
        sleep(0.2)
        self.press_key(button='r', mode='click')
        sleep(0.2)
        self.press_key(button='f', mode='click')
        sleep(0.2)
